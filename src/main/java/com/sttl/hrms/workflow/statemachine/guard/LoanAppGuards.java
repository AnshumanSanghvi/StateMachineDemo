package com.sttl.hrms.workflow.statemachine.guard;
...
import static com.sttl.hrms.workflow.statemachine.util.ExtendedStateHelper.getLong;
...
@Slf4j
public class LoanAppGuards {

    private LoanAppGuards() {
        // use class statically
    }

    public static boolean rollBackApproval(StateContext<LoanAppState, LoanAppEvent> context) {
    ...
    public static boolean approvalFlow(StateContext<LoanAppState, LoanAppEvent> context) {
    ...
    public static boolean approveInParallel(StateContext<LoanAppState, LoanAppEvent> context, Map<Integer, Long> reviewersMap) {
    ...
    public static boolean requestChanges(StateContext<LoanAppState, LoanAppEvent> context) {
    ...
    public static boolean forward(StateContext<LoanAppState, LoanAppEvent> context) {
    ...
    private static boolean reviewCountCheck(StateContext<LoanAppState, LoanAppEvent> context, String errorMsg) {
    ...
    private static boolean forwardIdAndOrderCheck(StateContext<LoanAppState, LoanAppEvent> context, String errorMsg) {
        Map<Integer, Long> reviewersMap = getMap(context, KEY_REVIEWERS_MAP);
        Pair<Integer, Long> forwardedBy = getPair(context, KEY_LAST_FORWARDED_BY);
    ...
    public static boolean approve(StateContext<LoanAppState, LoanAppEvent> context) {
