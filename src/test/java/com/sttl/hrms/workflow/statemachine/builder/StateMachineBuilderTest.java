...
import static com.sttl.hrms.workflow.statemachine.SMConstants.KEY_LAST_FORWARDED_BY;
...
class StateMachineBuilderTest {
    ...
    public StateMachineBuilderTest() throws Exception {
    ...
    void happyPath() {
        ...
        List<PassEventDto> passEvents1 = createPassEvents(0L, WorkflowType.LEAVE_APPLICATION, 1L, 0, "", E_CREATE,
        ...
        List<PassEventDto> passEvents2 = createPassEvents(0L, WorkflowType.LEAVE_APPLICATION, 123L, 1, "forwarded",
                E_FORWARD);
        ...
        List<PassEventDto> passEvents3 = createPassEvents(0L, WorkflowType.LEAVE_APPLICATION, 234L, 2, "forwarded",
                E_FORWARD);
        ...
        List<PassEventDto> passEvents4 = createPassEvents(0L, WorkflowType.LEAVE_APPLICATION, 345L, 3, "forwarded",
                E_FORWARD);
