...
import com.anshuman.workflow.App;
...
import com.anshuman.workflow.statemachine.config.StateMachinePersistenceConfig;
...
@DataJpaTest
@ContextConfiguration(classes = {App.class, LeaveAppStateMachineConfig.class, StateMachinePersistenceConfig.class})
...
//    private LeaveAppRepository leaveAppRepository;
    ...
    @Autowired
    DefaultStateMachineAdapter<LeaveAppState, LeaveAppEvent, LeaveAppWorkFlowInstanceEntity> stateMachineAdapter;
